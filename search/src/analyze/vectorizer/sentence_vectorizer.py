...
class TitleSentenceVectorizer(TextVectorizer):
    ...
    def __init__(self,
                 ...
                 matrix_file_name=os.path.join(PAPER_MATRIX_BASE_DIR, "title_sentence_vectorizer.pkl"),
                 *args, **kwargs):
        ...
        self.model = SentenceTransformer(os.path.join(settings.MODELS_BASE_DIR, 'sentence_transformer'), device='cpu')
